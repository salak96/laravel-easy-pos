<tr class="odd:bg-white even:bg-gray-100">
    ...
    <td class="px-2 py-1 border-r text-center dark:text-gray-800">
        <div class="flex items-center gap-1 dark:text-gray-800 w-32">
            <input type="number" min="1" wire:model.live.debounce.250ms="quantity"  class="bg-black text-center block w-full text-sm text-gray-900 border border-gray-300 rounded-md bg-gray-50 focus:ring-blue-500 focus:border-blue-500  dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-800 dark:focus:ring-blue-500 dark:focus:border-blue-500" />
            <button wire:click="removeFromCart"  wire:loading.attr="disabled" class="p-2 text-red bg-red-500 rounded hover:bg-red-600" title="Delete">
